...
async def main():
    ...
    logger.info("=====================================================================")
    logger.info("TikTok Interactive Login Setup Script")
    logger.info("=====================================================================")
    logger.info("This script will open Google Chrome on your screen so you can log in.")
    logger.info("Standard login or Google sign-in are fully supported.")
    ...
    async with async_playwright() as p:
        ...
        print("--> AFTER YOU SUCCESSFULLY LOG IN AND REACH THE TIKTOK DASHBOARD,")
