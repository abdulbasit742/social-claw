...
These instructions apply to the entire `abdulbasit742/social-claw` repository. More specific AGENTS.md or AGENTS.override.md files in subdirectories may refine them.
